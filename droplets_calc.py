...
class MainWindow(QWidget):
    ...
    def contrast_and_blurr(self, img, blurr_block):
        """
        INPUT:
    ...
    def calculate_drops_area(self, img, photo_number, blockSize, C):
        '''
        INPUT:
    ...
    def calculate_for_all_photos(self, address, files, blockSize, C, blurr_block):
        '''
        INPUT:
